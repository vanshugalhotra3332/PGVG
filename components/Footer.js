  ...
  return (
    showComponent && (
      <footer className="text-gray-600 body-font border-t-2 border-gray-200 border-opacity-60">
        <div className="container lg:px-52 md:px-30 xs:px-10 px-2 pb-24 pt-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
